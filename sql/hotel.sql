...
CREATE TABLE `User` (
  ...
  `points` double(255,0) DEFAULT NUll,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `User` VALUES (4,'1012681@qq.com','123456','测试一号','12345678919',100,'Client',0),(5,'123@qq.com','123456','测试二号','12345678911',100,'Client',0),(6,'333@qq.com','123456',NULL,NULL,NULL,'HotelManager',0);
