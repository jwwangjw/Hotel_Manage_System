...
public class HotelController {
    ...
    @GetMapping("{userId}/{keyWords}/{factor}/search")
    public ResponseVO searchHotels(@PathVariable int userId, @PathVariable String keyWords, @PathVariable String factor){
        return ResponseVO.buildSuccess(hotelService.searchHotels(userId,keyWords,factor));
    }
}
